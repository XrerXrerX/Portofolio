...
export default function Skills({ }: Props) {
    return (
        ...
        <motion.div
            ...
            className='h-screen flex relative flex-col text-center md:text-left xl:flex-row max-w-[2000px] px:10 xl:px-10 min-h-screen justify-evenly xl:space-y-0 mx-auto items-center'>
            ...
            <div className='grid grid-cols-3 md:grid-cols-4 xl:grid-cols-5  gap-2 md:gap-5 xl:gap-5'>
                <SkillApache />
                <SkillJs />
                <SkillBoostrap />
                <SkillCss />
