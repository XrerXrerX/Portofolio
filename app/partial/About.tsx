    ...
    return (
        <motion.div
            ...
            <motion.img
                ...
                viewport={{ once: true }}
                src="22.jpeg"
                className=' flex-shrink-0 w-24 h-24 rounded-full object-cover md:rounded-lg mt-0 md:mt-12 xl:mt-12 md:w-64 md:h-80 xl:w-[500px] xl:h-[600px]' />
            ...
            <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className='space-y-4 px-10 md:px-10'>
