...
export default function About({ }: Props) {
    return (
        <motion.div
            ...
            <h3 className='absolute top-20 md:top-24 xl:top-24 uppercase tracking-[20px] text-gray-500 text-2xl'>About</h3>
            <motion.img
                initial={{
                    x: -200,
                    opacity: 0
                ...
                viewport={{ once: true }}
                src="22.jpeg"
                className='-mb-20 md:mb-0 flex-shrink-0 w-24 h-24 rounded-full object-cover md:rounded-lg mt-24 md:mt-12 xl:mt-12 md:w-64 md:h-80 xl:w-[500px] xl:h-[600px]' />
            ...
            <motion.div
                ...
                <h4 className='text-xl md:text-2xl xl:text-3xl mt-8 md:mt-0 xl:mt-0 font-semibold'>My  <span className='underline decoration-[#F7AB0A]/50'>background</span> </h4>
