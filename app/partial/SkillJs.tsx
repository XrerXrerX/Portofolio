...
export default function SkillJs({ directionLeft }: Props) {
    return (
        <div className='group relative flex cursor-pointer'>
            ...
            />
            <div className=' absolute opacity-0 group-hover:opacity-90 transition duration-300 ease-in-out group-hover:bg-black w-16 h-16 md:w-24 md:h-24 xl:w-32 xl:h-32 rounded-full'>
