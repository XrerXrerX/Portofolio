...
export default function SkillJs({ directionLeft }: Props) {
  return (
    <div className="group relative flex cursor-pointer">
      ...
      />
      <div className=" absolute opacity-0 group-hover:opacity-90 transition duration-300 ease-in-out group-hover:bg-black 2xl:w-24 xl:w-24 lg:w-24 md:w-24 sm:w-24 xs:w-24 2xl:h-24 xl:h-24 lg:h-24 md:h-24 sm:h-24 xs:h-24 rounded-full">
