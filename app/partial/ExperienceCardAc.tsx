...
export default function ExperienceCardAc({}: Props) {
  return (
    <motion.article
      ...
      className="flex flex-col rounded-lg items-center space-y-2 flex-shrink-0 w-[800px] h-[780px] snap-center bg-[#060f14] p-10 hover:opacity-100 border-b-4 border-b-[#505f4c] opacity-50 cursor-pointer transition-opacity duration-200 overflow-hidden mt-36"
    >
      <motion.img
