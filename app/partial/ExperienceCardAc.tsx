    ...
    return (
        <article
            ...
            <div className='px-0 md:px-10 '>
                ...
                <p className='font-bold text-l md:text-xl xl:text-2xl mt-1 text-center'>PT BARA ALAM UTAMA (PT. AGATHIS ALAM INDONESIA)</p>

                <p className='text-[15px] md:text-xl uppercase py-5 md:py-5 text-gray-300 text-center'>started work June 2018 - 2019</p>
                <ul className='list-disc space-y-2 md:space-y-4 spa ml-5 text-[18px] md:text-xl'>
